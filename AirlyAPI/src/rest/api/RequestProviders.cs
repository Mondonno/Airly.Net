...
namespace AirlyAPI.Rest
{
    ...
    public class RestRequestProvider : IAirlyAuth
    {
        ...
        {
            RestManager = rest;
            RestRequest = new DeafultRestRequest(rest, end, method, options);
        }
        ...
        protected async Task<RawRestResponse> SendAsyncInternal(DeafultRestRequest request, bool handle)
        {
